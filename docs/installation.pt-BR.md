...
> ✅ Package público: `@ninjadatabuilder/n8n-nodes-google-tag-manager@0.5.2`
>
...
Em **Settings → Community Nodes**, confira `0.5.2`. No editor, pesquise `Google Tag Manager` e confirme:
...
| `404` no npm | Registry, versão ou rede incorretos | Use `registry.npmjs.org` e `0.5.2` |
