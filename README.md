...
[![Version](https://img.shields.io/badge/version-0.5.3-4c1)](https://www.npmjs.com/package/@ninjadatabuilder/n8n-nodes-google-tag-manager)

Role-separated, bounded Google Tag Manager API v2 nodes and OAuth credentials for **self-hosted n8n**.

> [!IMPORTANT]
> The public package is available as `@ninjadatabuilder/n8n-nodes-google-tag-manager@0.5.3`. Pin the version in production and validate the package in staging first.
...
| npm returns `404` | Wrong registry, version, or network | Use the official registry and pinned `0.5.3` |
