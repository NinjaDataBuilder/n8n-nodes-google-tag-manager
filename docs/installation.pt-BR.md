...
> ✅ Package público: `@ninjadatabuilder/n8n-nodes-google-tag-manager@0.5.5`
>
...
A referência do projeto foi validada com n8n `2.39.7` (versões mais novas também devem ser validadas em staging antes do uso em produção).
...
Em **Settings → Community Nodes**, confira `0.5.5`. No editor, pesquise `Google Tag Manager` e confirme:
...
| `404` no npm | Registry, versão ou rede incorretos | Use `registry.npmjs.org` e `0.5.5` |
...
- [README em português](https://github.com/NinjaDataBuilder/n8n-nodes-google-tag-manager/blob/main/docs/README.pt-BR.md)
- [README em inglês](https://github.com/NinjaDataBuilder/n8n-nodes-google-tag-manager/blob/main/docs/README.en.md)
